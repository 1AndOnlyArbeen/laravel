...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100 p-8">
        ...
        <div class="space-x-4">
            ...
            <a href="{{route('second')}}" class="inline-block bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition">
                Second
            </a>
            <a href="{{route('mythird')}}" class="inline-block bg-purple-500 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition">
                Third
            </a>
        </div>
